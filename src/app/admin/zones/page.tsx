  ...
  return (
    <AppShell title="Zones" nav="admin">
      <div className="space-y-6">
        <PageHeader
          title="Zones"
          description="Create zones and manage delivery addresses used for rotations."
        />
        ...
        {zones.length ? (
          ...
          <EmptyState
            title="No zones yet"
            description="Create your first zone to start allowlisting coordinators and building rotations."
          />
        )}
      </div>
    </AppShell>
